...
Contains the User, Client, and ClientCase models for storing user and client information.
"""
...
class ClientCase(Base):
    """ClientCase model representing relationships between users and clients."""
